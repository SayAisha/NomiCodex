...
export class RecipeList {
    constructor() {
        ...
        if (this.recipeItemsContainer === null) {
            console.log("Calculator UI absent (NEI-only mode), skipping RecipeList");
            const placeholder = () => document.createElement('div');
            this.productItemsContainer = placeholder();
            this.recipeItemsContainer = placeholder();
            this.searchContainer = placeholder();
            this.searchInput = document.createElement('input');
            this.searchClose = placeholder();
            if (!this.searchHighlightStyle)
                this.searchHighlightStyle = document.createElement('style');
            return;
        }
