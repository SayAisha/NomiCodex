...
export const singleBlockMachine = {
    ...
    excludesRecipe: (recipe) => {
        var _a, _b;
        return ((_b = (_a = recipe.gtRecipe) === null || _a === void 0 ? void 0 : _a.MetadataByKey("compression_tier")) !== null && _b !== void 0 ? _b : 0) > 0;
    }
};
...
machines["Component Assembly Line"] = {
    ...
    speed: (recipeModel, choices) => {
        var _a, _b, _c;
        const recipeCoalTier = (_c = (_b = (_a = recipeModel.recipe) === null || _a === void 0 ? void 0 : _a.gtRecipe) === null || _b === void 0 ? void 0 : _b.MetadataByKey("coal_casing_tier")) !== null && _c !== void 0 ? _c : 1;
...
machines["Naquadah Fuel Refinery"] = {
    ...
    overclocker: (recipeModel, choices) => {
        ...
        const recipeTierCoil = (_c = (_b = (_a = recipeModel.recipe) === null || _a === void 0 ? void 0 : _a.gtRecipe) === null || _b === void 0 ? void 0 : _b.MetadataByKey("nfr_coil_tier")) !== null && _c !== void 0 ? _c : 1;
    ...
    enforceChoiceConstraints: (recipe, choices) => {
        var _a, _b, _c;
        const recipeTier = (_c = (_b = (_a = recipe.recipe) === null || _a === void 0 ? void 0 : _a.gtRecipe) === null || _b === void 0 ? void 0 : _b.MetadataByKey("nfr_coil_tier")) !== null && _c !== void 0 ? _c : 1;
...
machines["Neutron Activator"] = {
    ...
    info: (recipeModel, choices) => {
        var _a, _b, _c;
        const nke = (_c = (_b = (_a = recipeModel.recipe) === null || _a === void 0 ? void 0 : _a.gtRecipe) === null || _b === void 0 ? void 0 : _b.MetadataByKey("nke_range")) !== null && _c !== void 0 ? _c : 0;
...
function makeSpaceAssemblerRecipeExcluder(tier) {
    return (recipe) => { var _a, _b; return ((_b = (_a = recipe.gtRecipe) === null || _a === void 0 ? void 0 : _a.MetadataByKey("space_elevator_module_tier")) !== null && _b !== void 0 ? _b : 0) > tier; };
}
...
function getEbfExcessHeat(recipe, choices) {
    var _a, _b, _c;
    const recipeHeat = (_c = (_b = (_a = recipe.recipe) === null || _a === void 0 ? void 0 : _a.gtRecipe) === null || _b === void 0 ? void 0 : _b.specialValue) !== null && _c !== void 0 ? _c : 0;
...
function laserOverclockCalculator(recipeModel, overclockTiers) {
    ...
    const durationTicks = (((_d = (_c = recipeModel.recipe) === null || _c === void 0 ? void 0 : _c.gtRecipe) === null || _d === void 0 ? void 0 : _d.durationTicks) || Number.POSITIVE_INFINITY);
    let overclockSpeed = 1;
    let overclockPower = 1;
    const maxRegularOverclocks = recipeModel.voltageTier - (((_f = (_e = recipeModel.recipe) === null || _e === void 0 ? void 0 : _e.gtRecipe) === null || _f === void 0 ? void 0 : _f.voltageTier) || TIER_LV);
...
machines["Nano Forge"] = {
    overclocker: (recipeModel, choices) => {
        ...
        const neededTier = (_c = (_b = (_a = recipeModel.recipe) === null || _a === void 0 ? void 0 : _a.gtRecipe) === null || _b === void 0 ? void 0 : _b.MetadataByKey("nano_forge_tier")) !== null && _c !== void 0 ? _c : 1;
    ...
    enforceChoiceConstraints: (recipeModel, choices) => {
        var _a, _b, _c;
        const tier = (_c = (_b = (_a = recipeModel.recipe) === null || _a === void 0 ? void 0 : _a.gtRecipe) === null || _b === void 0 ? void 0 : _b.MetadataByKey("nano_forge_tier")) !== null && _c !== void 0 ? _c : 1;
...
function makeCompressorRecipeExcluder(tier) {
    return (recipe) => { var _a, _b; return tier < ((_b = (_a = recipe.gtRecipe) === null || _a === void 0 ? void 0 : _a.MetadataByKey("compression_tier")) !== null && _b !== void 0 ? _b : 0); };
}
...
machines["Dimensionally Transcendent Plasma Forge"] = {
    ...
    recipe: (recipe, choices, items) => {
        ...
        if (choices.convergence > 0) {
            ...
            let amperage = ((_b = (_a = recipe.recipe) === null || _a === void 0 ? void 0 : _a.gtRecipe) === null || _b === void 0 ? void 0 : _b.amperage) || 1;
            let voltage = ((_d = (_c = recipe.recipe) === null || _c === void 0 ? void 0 : _c.gtRecipe) === null || _d === void 0 ? void 0 : _d.voltage) || TIER_LV;
            let machineConsumption = amperage * voltage * Math.pow(4, recipe.overclockTiers);
            let durationTicks = (((_f = (_e = recipe.recipe) === null || _e === void 0 ? void 0 : _e.gtRecipe) === null || _f === void 0 ? void 0 : _f.durationTicks) || 1) / Math.pow(4, recipe.overclockTiers);
...
machines["Quantum Force Transformer"] = {
    ...
    recipe: (recipe, choices, items) => {
        ...
        const focusTier = (_e = (_d = (_c = recipe.recipe) === null || _c === void 0 ? void 0 : _c.gtRecipe) === null || _d === void 0 ? void 0 : _d.MetadataByKey("qft_focus_tier")) !== null && _e !== void 0 ? _e : 1;
        const baseProbability = 1.0 / numOutputs;
        items = createEditableCopy(((_f = recipe.recipe) === null || _f === void 0 ? void 0 : _f.items) || []);
    ...
    enforceChoiceConstraints: (recipe, choices) => {
        var _a, _b, _c;
        const focusTier = (_c = (_b = (_a = recipe.recipe) === null || _a === void 0 ? void 0 : _a.gtRecipe) === null || _b === void 0 ? void 0 : _b.MetadataByKey("qft_focus_tier")) !== null && _c !== void 0 ? _c : 1;
...
machines["Draconic Evolution Fusion Crafter"] = {
    overclocker: (recipe, choices) => {
        ...
        const recipeTierCoil = (_c = (_b = (_a = recipe.recipe) === null || _a === void 0 ? void 0 : _a.gtRecipe) === null || _b === void 0 ? void 0 : _b.MetadataByKey("defc_casing_tier")) !== null && _c !== void 0 ? _c : 1;
        const maxPerfectOverclocks = Math.max(0, buildingTierCoil - recipeTierCoil);
        return StandardOverclocker.perfectThenNormal(maxPerfectOverclocks);
    },
    speed: 1,
    ...
    enforceChoiceConstraints: (recipe, choices) => {
        var _a, _b, _c;
        const recipeTier = (_c = (_b = (_a = recipe.recipe) === null || _a === void 0 ? void 0 : _a.gtRecipe) === null || _b === void 0 ? void 0 : _b.MetadataByKey("defc_casing_tier")) !== null && _c !== void 0 ? _c : 1;
...
function getFusionTier(recipe) {
    var _a, _b, _c, _d, _e, _f;
    const cost = (_b = (_a = recipe.gtRecipe) === null || _a === void 0 ? void 0 : _a.MetadataByKey("fusion_threshold")) !== null && _b !== void 0 ? _b : 0;
    const plasmaTier = (_d = (_c = recipe.gtRecipe) === null || _c === void 0 ? void 0 : _c.MetadataByKey("fog_plasma_tier")) !== null && _d !== void 0 ? _d : 0;
    const costTier = getFusionTierByStartupCost(cost);
    const voltageTier = (((_f = (_e = recipe.gtRecipe) === null || _e === void 0 ? void 0 : _e.voltageTier) !== null && _f !== void 0 ? _f : 0) - TIER_LUV + 1) || 0;
...
machines["Eye of Harmony"] = {
    ...
    recipe: (recipeModel, choices, items) => {
        ...
        const recipeDurationSeconds = (((_b = (_a = recipeModel.recipe) === null || _a === void 0 ? void 0 : _a.gtRecipe) === null || _b === void 0 ? void 0 : _b.durationSeconds) || 1) / getEyeOfHarmonySpeed(recipeModel, choices);
