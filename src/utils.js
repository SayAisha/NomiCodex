...
export const TIER_LV = 1;
export const TIER_MV = 2;
export const TIER_HV = 3;
export const TIER_EV = 4;
export const TIER_IV = 5;
export const TIER_LUV = 6;
export const TIER_ZPM = 7;
export const TIER_UV = 8;
export const TIER_UHV = 9;
export const TIER_UEV = 10;
export const TIER_UIV = 11;
export const TIER_UMV = 12;
export const TIER_UXV = 13;
export const TIER_MAX = 14;
